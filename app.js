const itinerary = [
  {
    ...
    mood: "여행 시작",
    note:
      "첫날은 설렘과 이동감을 충분히 담습니다. 반지는 아직 직접 보여주지 말고, 손과 캐리어, 공항 표정으로 이야기의 문을 엽니다.",
    tags: ["공항", "하카타역", "첫 식사"],
    schedule: [
      ["비행", "11:10 제주항공 7C1472 출발, 12:40 후쿠오카 도착. 예약 코드 UY2V7P."],
      ["이동", "국제선 공항버스 6번 또는 7번 승강장. 하카타역까지 약 20분, 1인 310엔."],
      ["숙소", "Mars Garden Hotel Hakata. 예약 번호 1739694152, 참조 코드 6204188608."],
      ["식사", "키와미야 하카타역 지하가점, 일 포르노 델 미뇽, 마에다야 하카타점."]
    ],
    shots: [
      ["공항 도착 표정", "입국장, 캐리어 손잡이, 둘이 처음 웃는 순간을 5초씩.", "B-roll"],
      ["하카타역 첫 컷", "역명, 발걸음, 손잡은 뒷모습을 이어 찍기.", "와이드"],
      ["첫 음식 리액션", "키와미야 돌판, 소스, 서로 한입 권하는 손.", "클로즈업"],
      ["호텔 체크인 후 창가", "방에 들어온 뒤 커튼 열고 여행이 시작된 표정.", "감정"],
      ["반지 암시 컷", "가방 안쪽 작은 케이스 실루엣만 2초. 직접 노출은 금지.", "링"]
    ],
    ring: [
      ["숨겨둔 시작", "반지 케이스는 가방이나 파우치에 넣은 채 질감만 살짝 보여줍니다."],
      ["편집 포인트", "아로하 전주나 첫 소절에 공항, 역, 손 컷을 빠르게 연결합니다."],
      ["주의", "식당 웨이팅 중에는 카메라를 오래 들지 말고 짧은 손동작 위주로 촬영합니다."]
    ]
  },
  {
    id: "0810",
    ...
    mood: "둘만의 여정",
    note:
      "도시에서 온천 여행지로 넘어가는 날입니다. 창밖, 버스터미널, 좌석 위 손을 중심으로 ‘둘만 아는 계획’의 분위기를 만듭니다.",
    tags: ["버스", "벳푸", "온천 숙소"],
    schedule: [
      ["아점 후보", "탄야 하카타, 우치노타마고, 다코멧카, 요시노야 중 현장 컨디션에 맞춰 선택."],
      ["이동", "12:01 하카타 버스터미널 3F 34번 승차장, 14:45 벳푸기타하마 도착. 예약 번호 43080325."],
      ["숙소", "Beppu Hatto Onyado Nono Beppu. 예약 번호 1739694152, 참조 코드 6204188608."],
      ["저녁", "킨타로스시 벳푸. 후토마키 105번 메모."]
    ],
    shots: [
      ["터미널 대기", "버스 표지판, 승차장 번호, 캐리어 옆에서 기다리는 모습.", "정보"],
      ["버스 창밖", "창가에 비친 얼굴과 지나가는 풍경을 10초 이상.", "감정"],
      ["손 위의 햇빛", "좌석에서 손잡은 장면. 반지는 아직 손에 끼우지 않음.", "링"],
      ["벳푸 도착", "기타하마 도착 표지, 숙소 방향으로 걷는 뒷모습.", "와이드"],
      ["초밥 저녁", "메뉴판, 접시, 서로 고르는 손만 짧게.", "B-roll"]
    ],
    ring: [
      ["감정 축적", "‘곧 말하고 싶은 마음’만 보이게 합니다. 케이스 대신 손과 시선이 주인공입니다."],
      ["촬영 팁", "버스 흔들림은 일부러 살려도 좋습니다. 안정된 컷은 도착 후 보충합니다."],
      ["대체 컷", "비가 오면 버스 창문 물방울과 손 실루엣으로 분위기를 만듭니다."]
    ]
  },
  {
    id: "0811",
    ...
    mood: "가까워지는 거리",
    note:
      "벳푸의 낮과 저녁을 이용해 자연스러운 커플 컷을 많이 확보합니다. 여자친구가 카메라를 의식하지 않는 순간이 핵심입니다.",
    tags: ["토요츠네", "산책", "저녁"],
    schedule: [
      ["점심", "토요츠네본점은 수요일 휴무, 점심 피크 대기 길 수 있음. 오픈 직후 추천."],
      ["대안", "분고차야에서 당고지루, 토리텐정식, 소바정식, 야세우마."],
      ["저녁", "소무리 스테이크는 비싼 편. 로바타진은 오픈 시간대 또는 호텔 프런트 당일 문의."],
      ["Plan B", "가성비 이자카야로 전환 가능."]
    ],
    shots: [
      ["오픈런 발걸음", "식당 앞 간판, 둘이 줄 서는 발, 메뉴를 보는 옆모습.", "현장"],
      ["식탁 위 손", "젓가락, 물컵, 손등을 자연스럽게. 반지 손가락 구도 연습.", "링"],
      ["벳푸 거리 와이드", "조용한 골목이나 횡단보도에서 7초 이상.", "와이드"],
      ["웃음 리액션", "농담 직후 웃는 얼굴을 세로로 한 번, 가로로 한 번.", "감정"],
      ["밤 식당 입구", "간판 불빛, 문 열고 들어가는 뒷모습.", "전환"]
    ],
    ring: [
      ["손 구도 리허설", "프로포즈 당일 손 클로즈업을 위해 오늘은 손 위치와 초점을 미리 연습합니다."],
      ["편집 포인트", "아로하 후렴 전, 둘이 가까워지는 몽타주로 쓰기 좋습니다."],
      ["주의", "비싼 식당에서는 촬영보다 식사 경험을 우선하고, 입장 전후 컷만 챙깁니다."]
    ]
  },
  {
    id: "0812",
    ...
    mood: "고백의 중심",
    note:
      "가장 중요한 촬영일입니다. 호텔에 문의한 저녁 전후로 조용한 시간대를 확보하고, 반지와 고백 컷을 무리 없이 찍는 것을 목표로 합니다.",
    tags: ["핵심일", "반지", "호텔식"],
    schedule: [
      ["낮", "체력 아끼기. 숙소 주변 산책, 손 컷, 반지 단독 컷 위주."],
      ["저녁", "호텔에 문의해서 호텔식 가능 여부 확인."],
      ["대안", "야키토리 또는 가까운 식당으로 가볍게 전환."],
      ["준비", "반지, 케이스, 작은 천, 휴대폰 배터리, 보조 조명 확인."]
    ],
    shots: [
      ["반지 단독 컷", "창가 자연광에서 케이스 열림, 반지 측면, 손에 올린 컷.", "링"],
      ["고백 직전", "복도나 방 안에서 숨 고르는 손, 문고리, 꽃이나 선물 디테일.", "감정"],
      ["프로포즈 순간", "가능하면 고정 구도로 30초 이상. 말소리까지 살리기.", "필수"],
      ["반지 착용", "손가락에 들어가는 순간은 흔들려도 좋으니 가까이.", "필수"],
      ["후렴 엔딩 컷", "둘이 손잡고 웃는 10초. 초점은 반지보다 표정.", "엔딩"],
      ["반지 인서트", "호텔 조명 아래 반짝임, 케이스와 손을 번갈아 5초씩.", "링"]
    ],
    ring: [
      ["메인 연출", "반지를 보여주는 장면보다 ‘말하기 직전의 떨림’을 먼저 보여주면 감정이 자연스럽습니다."],
      ["카메라 배치", "휴대폰 하나는 고정 촬영, 다른 하나는 손 클로즈업 보조로 쓰면 실패 확률이 줄어듭니다."],
      ["대체 플랜", "장소가 애매하면 호텔 방 창가나 조용한 복도 쪽에서 짧고 진심 있게 갑니다."],
      ["사운드", "프로포즈 멘트 원본 음성은 꼭 남겨두세요. MV 마지막에 작게 섞으면 힘이 큽니다."]
    ]
  },
  {
    id: "0813",
    ...
    mood: "도시로 돌아오는 마음",
    note:
      "벳푸에서 만든 감정을 하카타의 활기로 옮겨옵니다. 반지를 낀 손이 자연스럽게 등장하기 시작하는 날입니다.",
    tags: ["JR", "라멘", "야키니쿠"],
    schedule: [
      ["이동", "JR 11:19 벳푸 출발, 13:28 하카타역 도착. 소닉 24, 예약번호 5572103138."],
      ["주의", "실물 승차권으로 미리 교환."],
      ["숙소", "S-Peria Hotel Hakata. 예약 번호 1739700820."],
      ["식사", "신신라멘, 잇푸도, 이치란, 카네토라, 잇코샤 중 선택. 저녁은 야키니쿠 타규 또는 돈카츠 와카바."]
    ],
    shots: [
      ["JR 티켓과 손", "실물 승차권을 든 손. 반지가 보이면 자연스럽게.", "링"],
      ["기차 좌석", "창가, 도시로 돌아오는 표정, 손가락 클로즈업.", "전환"],
      ["하카타역 복귀", "역명 앞에서 짧은 세로 컷. 여행 2막 시작 느낌.", "와이드"],
      ["라멘 김", "그릇 위 김, 젓가락, 웃는 리액션.", "B-roll"],
      ["저녁 손 컷", "건배나 고기 굽는 손에 반지가 살짝 보이게.", "링"]
    ],
    ring: [
      ["노출 전환", "이날부터는 반지를 숨기지 않고 일상 속에 자연스럽게 등장시킵니다."],
      ["편집 포인트", "프로포즈 직후 후렴 반복 구간에 ‘반지가 함께 있는 여행’으로 전환합니다."],
      ["주의", "식당 조명이 강하면 반지가 날아갈 수 있으니 화면 밝기를 살짝 낮춰 찍습니다."]
    ]
  },
  {
    id: "0814",
    ...
    mood: "우리의 기념품",
    note:
      "마지막 밤은 선물, 음식, 밤거리로 엔딩 재료를 모읍니다. 화려함보다 ‘이제 돌아가도 남는 것’에 집중합니다.",
    tags: ["선물", "장어", "마지막 밤"],
    schedule: [
      ["숙소", "S-Peria Hotel Hakata. 예약 번호 1739700820."],
      ["식사 후보", "요시즈카 우나기야, 모츠나베 라쿠텐치 2대, 다이치노 우동."],
      ["쇼핑", "선물용 과자는 공항 면세점만 믿지 말고 하카타역 또는 시내에서 미리 구매."],
      ["이동", "평일 5시 요시즈카 우나기야는 택시 이용 고려."]
    ],
    shots: [
      ["선물 고르는 손", "과자 박스, 쇼핑백, 반지가 보이는 손.", "링"],
      ["마지막 식사", "음식보다 서로 바라보는 장면을 우선.", "감정"],
      ["밤거리 걷기", "하카타 조명 아래 뒷모습 10초 이상.", "엔딩"],
      ["호텔 귀환", "엘리베이터 거울, 방 카드, 캐리어 옆 반지 손.", "전환"],
      ["감사 멘트", "서로에게 한마디를 10초씩 음성까지 녹화.", "필수"]
    ],
    ring: [
      ["엔딩 재료", "반지 낀 손으로 선물을 드는 장면은 귀국 엔딩과 잘 이어집니다."],
      ["사운드", "거리 소음이 있어도 짧은 실제 대화가 들어가면 영상이 살아납니다."],
      ["대체 컷", "비가 오면 우산 손잡이와 반지 손을 찍습니다."]
    ]
  },
  {
    id: "0815",
    ...
    mood: "엔딩",
    note:
      "마지막은 공항과 비행기로 마무리합니다. 반지, 손, 캐리어, 탑승권을 엮어 여행이 하나의 약속으로 끝나게 만듭니다.",
    tags: ["공항", "귀국", "마무리"],
    schedule: [
      ["이동", "하카타역 지쿠시 출입구에서 버스터미널 방향. 11번 승강장 탑승, 1인 310엔."],
      ["목표", "9:30 또는 9:50 차 타깃. 마지노선 10:10, 이후 10:35."],
      ["비행", "13:40 제주항공 7C1472. 예약 코드 UY2V7P."],
      ["주의", "후쿠오카 공항 국제선 수속과 보안검색 줄이 길 수 있어 출발 2시간 30분에서 3시간 전 도착."]
    ],
    shots: [
      ["버스 정류장", "11번 승강장, 캐리어, 손잡은 장면.", "정보"],
      ["공항 체크인", "줄, 탑승권, 여권 커버, 반지 손.", "링"],
      ["기념품 정리", "쇼핑백과 반지 낀 손을 한 화면에.", "B-roll"],
      ["비행기 창가", "구름, 손, 창문 반사.", "엔딩"],
      ["마지막 손 컷", "두 손을 겹치고 8초 정지. 아로하 마지막 소절용.", "필수"]
    ],
    ring: [
      ["마지막 이미지", "반지는 주인공이지만 과시하지 않고 ‘함께 돌아가는 약속’으로 보여줍니다."],
      ["편집 포인트", "마지막 10초는 실제 손 컷과 공항 소리를 살짝 남기면 좋습니다."],
      ["주의", "공항에서는 보안구역 촬영 제한이 있을 수 있으니 표지와 직원은 피해서 찍습니다."]
    ]
  }
];
...
function countDayDone(day) {
  return day.shots.filter((_, index) => state.checked[shotKey(day.id, index)]).length;
}
...
function renderDays() {
  const template = document.querySelector("#dayButtonTemplate");
  dayList.innerHTML = "";
...
function renderHero(day) {
  selectedMood.textContent = day.mood;
  selectedTitle.textContent = `${day.date} ${day.title}`;
  selectedDirectorNote.textContent = day.note;
...
function renderShots(day) {
  ...
  day.shots.forEach(([title, detail, meta], index) => {
    const key = shotKey(day.id, index);
    const node = template.content.firstElementChild.cloneNode(true);
    ...
    node.querySelector(".shot-meta").textContent = meta;
...
function renderInfo(day) {
  ...
  ringPlan.innerHTML = day.ring
    .map(([title, detail], index) => {
      const finalClass = index === day.ring.length - 1 ? " final" : "";
      return `<article class="ring-card${finalClass}"><strong>${title}</strong><p>${detail}</p></article>`;
    })
    .join("");
}
...
document.querySelector("#completeDayBtn").addEventListener("click", () => {
  const day = getDay();
  day.shots.forEach((_, index) => {
    state.checked[shotKey(day.id, index)] = true;
  });
  save();
  render();
});
...
document.querySelector("#exportBtn").addEventListener("click", () => {
  ...
  link.href = url;
  link.download = "aloha-mv-progress.json";
  link.click();
